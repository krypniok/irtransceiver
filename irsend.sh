...
# Variablen für Serial Port
SERIAL_DEV="/dev/ttyUSB0"

# Konfiguration des Serial Ports (115200 Baud, raw mode)
stty -F "$SERIAL_DEV" 115200 raw -echo -hupcl
...
declare -A MACROS=(
    ...
    [_HDMI]="KEY_SRC KEY_SRC KEY_SRC KEY_SRC KEY_SRC KEY_SRC KEY_SRC KEY_SRC KEY_OKAY"
    [_DTV]="KEY_SRC KEY_SRC KEY_SRC KEY_SRC KEY_OKAY"
